...
<svg width="208px" height="208px" viewBox="0 0 208 208" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <defs>
        ...
        <circle id="path-10" cx="83" cy="11" r="5"></circle>
        ...
        <circle id="path-12" cx="83" cy="11" r="2.5"></circle>
        ...
        <text id="text-14" font-family="Helvetica" font-size="20" font-weight="normal" fill="#F5A623">
            <tspan x="0.5" y="19">10.10</tspan>
        </text>
        <filter x="-11.8%" y="-25.0%" width="123.5%" height="150.0%" filterUnits="objectBoundingBox" id="filter-15">
            <feOffset dx="0" dy="0" in="SourceAlpha" result="shadowOffsetOuter1"></feOffset>
            <feGaussianBlur stdDeviation="2" in="shadowOffsetOuter1" result="shadowBlurOuter1"></feGaussianBlur>
            <feColorMatrix values="0 0 0 0 0.960784314   0 0 0 0 0.650980392   0 0 0 0 0.137254902  0 0 0 1 0" type="matrix" in="shadowBlurOuter1"></feColorMatrix>
        </filter>
        ...
        <g id="4" transform="translate(4.000000, 3.000000)">
            <g id="container">
                ...
                <g id="knob" transform="translate(16.000000, 16.000000)">
                    ...
                    <circle id="Oval" stroke="#454545" fill="#3D3D3D" cx="84" cy="84" r="36"></circle>
                    <g id="Oval-3">
                ...
                <g id="label" transform="translate(75.000000, 87.000000)" fill="#F5A623" fill-opacity="1">
                    <g id="labeltext">
