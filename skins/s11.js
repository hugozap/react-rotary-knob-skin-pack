...
<svg width="208px" height="208px" viewBox="0 0 208 208" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <defs>
        ...
        <circle id="path-2" cx="101" cy="101" r="100"></circle>
        ...
        <circle id="path-5" cx="101" cy="101" r="86"></circle>
        ...
        <text id="text-7" font-family="Helvetica" font-size="44" font-weight="normal" fill="#DD9826">
            <tspan x="46" y="117.509804">10.10</tspan>
        </text>
        <filter x="-5.3%" y="-11.3%" width="110.5%" height="122.6%" filterUnits="objectBoundingBox" id="filter-8">
            <feOffset dx="0" dy="0" in="SourceAlpha" result="shadowOffsetOuter1"></feOffset>
            <feGaussianBlur stdDeviation="2" in="shadowOffsetOuter1" result="shadowBlurOuter1"></feGaussianBlur>
            <feColorMatrix values="0 0 0 0 0.91372549   0 0 0 0 0.623529412   0 0 0 0 0.141176471  0 0 0 1 0" type="matrix" in="shadowBlurOuter1"></feColorMatrix>
        </filter>
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="s11" transform="translate(3.000000, 3.000000)">
            <g id="container">
                <g id="Oval-2">
                ...
                <g id="knob" transform="translate(30.000000, 30.431373)">
                    <circle id="Oval-5" fill="#322E2E" cx="71" cy="71" r="71"></circle>
                    <path d="M72.5,1.61251045 L89,14.78544 C81.8011199,16.0640554 76.3011199,16.7033631 72.5,16.7033631 C68.6988801,16.7033631 63.1988801,16.0640554 56,14.78544 L72.5,1.61251045 Z" id="Rectangle" fill="#EF7C7C" transform="translate(72.500000, 9.157937) scale(1, -1) translate(-72.500000, -9.157937) "></path>
                </g>
                <g id="label">
                    <g id="labeltext" fill-opacity="1" fill="#DD9826">
                        <use filter="url(#filter-8)" xlink:href="#text-7"></use>
                        <use xlink:href="#text-7"></use>
                    </g>
                    <circle id="Oval-6" stroke="#979797" fill-opacity="0.730000019" fill="url(#pattern-9)" transform="translate(101.000000, 100.411765) rotate(-45.000000) translate(-101.000000, -100.411765) " cx="101" cy="100.411765" r="71"></circle>
                </g>
            </g>
        </g>
    </g>
